      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-muted-foreground">
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-3">
            <a href="https://github.com/suleiman-code" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground hover:text-foreground"><Github className="w-4 h-4" /></a>
