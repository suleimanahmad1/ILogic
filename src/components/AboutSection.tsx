...
const cards = [
  ...
  { title: "AI Automation", desc: "End-to-end workflow automation with n8n — integrating AI agents, APIs, and data pipelines." },
...
const AboutSection = () => {
  return (
    <section id="about" className="section-padding relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.08),transparent_35%),linear-gradient(180deg,rgba(255,255,255,0.02),transparent)]" />
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <motion.div initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <p className="section-sub">AI & Full Stack Engineer with 3+ years building intelligent, automated systems — bridging sophisticated AI backends with intuitive interfaces.</p>
